...
<table>
  <tr>
    <td valign="top" width="65%">
      ...
      <ul>
        <li>🚀 Estudante de <b>Ciências da Computação</b> (3º Semestre).</li>
        <li>📖 Melhorando e revisando matéria a cada dia!</li>
        <li>🔍 Buscando oportunidades de estágio na área de tecnologia.</li>
      </ul>
      <h3>🛠️ Tecnologias e Ferramentas</h3>
      <a href="https://skillicons.dev">
        <img src="https://skillicons.dev/icons?i=java,php,python,c,mysql,js,figma,html" />
      </a>
    </td>
    <td valign="top" width="35%" align="center">
      <img src="https://preview.redd.it/how-often-do-you-rewatch-ben-10-personally-i-watch-it-2-4-v0-t4mvkfum8wze1.jpeg?auto=webp&s=f9eeed0d5c7ab05d1adf3f0fc8a0f7e914958da1" width="180px" style="border-radius: 10px;" />
    </td>
  </tr>
</table>
